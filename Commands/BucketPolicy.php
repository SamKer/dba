...
class BucketPolicy extends Command
{

protected function configure()
    {
        $this->setName("bucket:policy")
		->setDescription('list policy on bucket')
...
protected function execute(InputInterface $input, OutputInterface $output)
{
	...
	if(!$target) {
        ...
        $io->title("Buckets Acls List $target");
